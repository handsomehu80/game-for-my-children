...
// 神秘大洋区域布局 (25个区域)
// 神秘主题：7条知识链 + 隐藏区域 + 宝藏区域 + Boss
export const mystAreas: Area[] = [
  // 语文链 (x=1)
  {
    id: 'myst_chinese_1',
    oceanId: 'mysterious',
    ...
    position: { x: 1, z: 1 },
    requiredKeys: 0,
    monsterId: 'ghost_bear_1',
    connections: ['myst_math_1', 'myst_english_1', 'myst_science_1', 'myst_physics_1', 'myst_chemistry_1', 'myst_history_1', 'myst_chinese_2'],
  },
  {
    id: 'myst_chinese_2',
    oceanId: 'mysterious',
    ...
    position: { x: 1, z: 3 },
    requiredKeys: 0,
    monsterId: 'ghost_bear_2',
    connections: ['myst_math_2', 'myst_english_2', 'myst_science_2', 'myst_physics_2', 'myst_chemistry_2', 'myst_history_2', 'myst_chinese_1', 'myst_chinese_3'],
  },
  {
    id: 'myst_chinese_3',
    oceanId: 'mysterious',
    ...
    position: { x: 1, z: 5 },
    requiredKeys: 0,
    monsterId: 'ghost_bear_3',
    connections: ['myst_math_3', 'myst_english_3', 'myst_science_3', 'myst_physics_3', 'myst_chemistry_3', 'myst_history_3', 'myst_chinese_2', 'myst_boss'],
  },
  ...
  // 数学链 (x=2.5)
  {
    ...
    position: { x: 2.5, z: 1 },
    requiredKeys: 0,
    monsterId: 'ghost_penguin_1',
    connections: ['myst_chinese_1', 'myst_english_1', 'myst_science_1', 'myst_physics_1', 'myst_chemistry_1', 'myst_history_1', 'myst_math_2'],
  },
  {
    id: 'myst_math_2',
    oceanId: 'mysterious',
    ...
    position: { x: 2.5, z: 3 },
    requiredKeys: 0,
    monsterId: 'ghost_penguin_2',
    connections: ['myst_chinese_2', 'myst_english_2', 'myst_science_2', 'myst_physics_2', 'myst_chemistry_2', 'myst_history_2', 'myst_math_1', 'myst_math_3'],
  },
  {
    id: 'myst_math_3',
    oceanId: 'mysterious',
    ...
    position: { x: 2.5, z: 5 },
    requiredKeys: 0,
    monsterId: 'ghost_penguin_3',
    connections: ['myst_chinese_3', 'myst_english_3', 'myst_science_3', 'myst_physics_3', 'myst_chemistry_3', 'myst_history_3', 'myst_math_2', 'myst_boss'],
  },
  ...
  // 英语链 (x=4)
  {
    ...
    position: { x: 4, z: 1 },
    requiredKeys: 0,
    monsterId: 'ghost_seal_1',
    connections: ['myst_chinese_1', 'myst_math_1', 'myst_science_1', 'myst_physics_1', 'myst_chemistry_1', 'myst_history_1', 'myst_english_2'],
  },
  {
    id: 'myst_english_2',
    oceanId: 'mysterious',
    ...
    position: { x: 4, z: 3 },
    requiredKeys: 0,
    monsterId: 'ghost_seal_2',
    connections: ['myst_chinese_2', 'myst_math_2', 'myst_science_2', 'myst_physics_2', 'myst_chemistry_2', 'myst_history_2', 'myst_english_1', 'myst_english_3'],
  },
  {
    id: 'myst_english_3',
    oceanId: 'mysterious',
    ...
    position: { x: 4, z: 5 },
    requiredKeys: 0,
    monsterId: 'ghost_seal_3',
    connections: ['myst_chinese_3', 'myst_math_3', 'myst_science_3', 'myst_physics_3', 'myst_chemistry_3', 'myst_history_3', 'myst_english_2', 'myst_boss'],
  },
  ...
  // 科学链 (x=5.5)
  {
    ...
    position: { x: 5.5, z: 1 },
    requiredKeys: 0,
    monsterId: 'ghost_jellyfish_1',
    connections: ['myst_chinese_1', 'myst_math_1', 'myst_english_1', 'myst_physics_1', 'myst_chemistry_1', 'myst_history_1', 'myst_science_2'],
  },
  {
    id: 'myst_science_2',
    oceanId: 'mysterious',
    ...
    position: { x: 5.5, z: 3 },
    requiredKeys: 0,
    monsterId: 'ghost_jellyfish_2',
    connections: ['myst_chinese_2', 'myst_math_2', 'myst_english_2', 'myst_physics_2', 'myst_chemistry_2', 'myst_history_2', 'myst_science_1', 'myst_science_3'],
  },
  {
    id: 'myst_science_3',
    oceanId: 'mysterious',
    ...
    position: { x: 5.5, z: 5 },
    requiredKeys: 0,
    monsterId: 'ghost_jellyfish_3',
    connections: ['myst_chinese_3', 'myst_math_3', 'myst_english_3', 'myst_physics_3', 'myst_chemistry_3', 'myst_history_3', 'myst_science_2', 'myst_boss'],
  },
  ...
  // 物理链 (x=7)
  {
    ...
    position: { x: 7, z: 1 },
    requiredKeys: 0,
    monsterId: 'ghost_eagle_1',
    connections: ['myst_chinese_1', 'myst_math_1', 'myst_english_1', 'myst_science_1', 'myst_chemistry_1', 'myst_history_1', 'myst_physics_2'],
  },
  {
    id: 'myst_physics_2',
    oceanId: 'mysterious',
    ...
    position: { x: 7, z: 3 },
    requiredKeys: 0,
    monsterId: 'ghost_eagle_2',
    connections: ['myst_chinese_2', 'myst_math_2', 'myst_english_2', 'myst_science_2', 'myst_chemistry_2', 'myst_history_2', 'myst_physics_1', 'myst_physics_3'],
  },
  {
    id: 'myst_physics_3',
    oceanId: 'mysterious',
    ...
    position: { x: 7, z: 5 },
    requiredKeys: 0,
    monsterId: 'ghost_eagle_3',
    connections: ['myst_chinese_3', 'myst_math_3', 'myst_english_3', 'myst_science_3', 'myst_chemistry_3', 'myst_history_3', 'myst_physics_2', 'myst_boss'],
  },
  ...
  // 化学链 (x=8.5)
  {
    ...
    position: { x: 8.5, z: 1 },
    requiredKeys: 0,
    monsterId: 'ghost_turtle_1',
    connections: ['myst_chinese_1', 'myst_math_1', 'myst_english_1', 'myst_science_1', 'myst_physics_1', 'myst_history_1', 'myst_chemistry_2'],
  },
  {
    id: 'myst_chemistry_2',
    oceanId: 'mysterious',
    ...
    position: { x: 8.5, z: 3 },
    requiredKeys: 0,
    monsterId: 'ghost_turtle_2',
    connections: ['myst_chinese_2', 'myst_math_2', 'myst_english_2', 'myst_science_2', 'myst_physics_2', 'myst_history_2', 'myst_chemistry_1', 'myst_chemistry_3'],
  },
  {
    id: 'myst_chemistry_3',
    oceanId: 'mysterious',
    ...
    position: { x: 8.5, z: 5 },
    requiredKeys: 0,
    monsterId: 'ghost_turtle_3',
    connections: ['myst_chinese_3', 'myst_math_3', 'myst_english_3', 'myst_science_3', 'myst_physics_3', 'myst_history_3', 'myst_chemistry_2', 'myst_boss'],
  },
  ...
  // 历史链 (x=10)
  {
    ...
    position: { x: 10, z: 1 },
    requiredKeys: 0,
    monsterId: 'ghost_snake_1',
    connections: ['myst_chinese_1', 'myst_math_1', 'myst_english_1', 'myst_science_1', 'myst_physics_1', 'myst_chemistry_1', 'myst_history_2'],
  },
  {
    id: 'myst_history_2',
    oceanId: 'mysterious',
    ...
    position: { x: 10, z: 3 },
    requiredKeys: 0,
    monsterId: 'ghost_snake_2',
    connections: ['myst_chinese_2', 'myst_math_2', 'myst_english_2', 'myst_science_2', 'myst_physics_2', 'myst_chemistry_2', 'myst_history_1', 'myst_history_3'],
  },
  {
    id: 'myst_history_3',
    oceanId: 'mysterious',
    ...
    position: { x: 10, z: 5 },
    requiredKeys: 0,
    monsterId: 'ghost_snake_3',
    connections: ['myst_chinese_3', 'myst_math_3', 'myst_english_3', 'myst_science_3', 'myst_physics_3', 'myst_chemistry_3', 'myst_history_2', 'myst_boss'],
  },
  ...
  // 隐藏区域 (需要钥匙)
  {
    ...
    position: { x: 1.5, z: 0 },
    requiredKeys: 1,
    monsterId: 'shadow_guardian',
    connections: ['myst_chinese_1'],
  },
  {
    id: 'myst_hidden_B',
    oceanId: 'mysterious',
  ...
  // Boss区域
  {
    ...
    position: { x: 5, z: 8 },
    requiredKeys: 0,
    monsterId: 'kraken_prime',
    connections: ['myst_chinese_3', 'myst_math_3', 'myst_english_3', 'myst_science_3', 'myst_physics_3', 'myst_chemistry_3', 'myst_history_3'],
  },
]
